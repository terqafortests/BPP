...
public class PORT3858Test extends MainClass {
	...
	public void port3858Test() {
		...
		assertTrue(
				getElementText(SelectPaperPage.messageArea)
						.equals("You are currently not enrolled in any courses at this time")
				|| getElementText(SelectPaperPage.messageArea)
						.equals("You are currently enrolled in one or more courses that have not started. Please log back in when your course is scheduled to start."),
				"Verifying if messages are displayed");
